...
public class AdapterListExpand extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<TravelHistoryModel> items = new ArrayList<>();
    private Context ctx;
    ...
    public AdapterListExpand(Context context, List<TravelHistoryModel> items, int animation_type) {
        this.items = items;
        ctx = context;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            final TravelHistoryModel p = items.get(position);
            view.name.setText(DivideYoddhaId(p.getYoddhaId()));
